...
_Daftar kategori nsfw_ : waifu, neko, blowjob
...
exports.torrent = () => {
    return `_Torrent downloader_
*${prefix}torrent list* = daftar info torrent yang sedang berjalan
*${prefix}torrent download* [magnet_link] = download torrent dari magnet link yang diberikan
*${prefix}torrent remove* [magnet_link] = hapus torrent yang sedang berjalan berdasarkan magnet link
*${prefix}torrent status* [magnet_link] = menampilkan info status torrent berdasarkan magnet link

*Website Torrent* : https://buat-donlot.herokuapp.com/`
}
